...
## H) Assumptions
- Release 0.1 uses export artifact placeholders and always includes a “Prep tasks” step; see `docs/DECISIONS.md` (2026-02-04). (Money_Map_Spec_Packet.pdf p.4, p.6–7)
