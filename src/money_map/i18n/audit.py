...
CORE_KEYS = [
    ...
    "ui.data_explorer.tab_conflicts",
    ...
    "ui.data_explorer.rulepack_authoring_header",
    "ui.data_explorer.rulepack_authoring_country",
    "ui.data_explorer.rulepack_authoring_validate",
    "ui.data_explorer.rulepack_authoring_valid",
    "ui.data_explorer.rulepack_authoring_lint",
    "ui.data_explorer.rulepack_authoring_clean",
    "ui.data_explorer.rulepack_authoring_scaffold",
    "ui.data_explorer.rulepack_authoring_scaffolded",
    "ui.data_explorer.rulepack_authoring_workspace_required",
    ...
    "ui.data_explorer.conflicts_header",
    "ui.data_explorer.conflicts_none",
    "ui.data_explorer.conflict_entity",
    "ui.data_explorer.conflict_type",
    "ui.data_explorer.conflict_action",
    "ui.workspace.path",
    "ui.workspace.load",
    ...
    "cli.workspace.conflicts_header",
    "cli.workspace.conflict_entity",
    "cli.workspace.conflict_type",
    "cli.workspace.conflict_action",
    "cli.workspace.resolved",
    "cli.simulate.export_done",
    "cli.rulepack.scaffold.done",
    "cli.rulepack.not_found",
    "cli.rulepack.kit_added",
    "cli.rulepack.validate_ok",
    "cli.rulepack.lint_done",
    "validate.source_summary",
    "validate.rulepack_placeholder_notice",
    ...
    "rulepack.placeholder.notice",
    "conflict.overlay_collision",
    "conflict.overlay_incomplete",
    "conflict.action.resolve_precedence",
    "conflict.action.use_canonical_or_manual",
    "rulepack.invalid_format",
    "rulepack.missing_keys",
    "rulepack.placeholder_missing_notice",
    "rulepack.invalid_rules",
    "rulepack.invalid_kits",
    "rulepack.rule_invalid",
    "rulepack.rule_missing_key",
    "rulepack.kit_invalid",
    "rulepack.kit_missing_key",
    "rulepack.rule_ids_duplicate",
    "rulepack.kit_ids_duplicate",
