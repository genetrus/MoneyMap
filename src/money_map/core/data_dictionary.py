...
DATA_DICTIONARY = [
    ...
    DictionaryEntry(
        path="data/presets.yaml",
        purpose="Objective presets with scoring weights and optional overrides.",
        model="ObjectivePreset[]",
        fields=[
            FieldInfo("preset_id", "string", True, "Unique preset identifier."),
            FieldInfo("title_key", "string", True, "i18n key for preset title."),
            FieldInfo("summary_key", "string", True, "i18n key for preset summary."),
            FieldInfo("weight_feasibility", "float", True, "Weight for feasibility score."),
            FieldInfo("weight_economics", "float", True, "Weight for economics score."),
            FieldInfo("weight_legal", "float", True, "Weight for legal score."),
            FieldInfo("weight_fit", "float", True, "Weight for fit score."),
            FieldInfo("weight_staleness", "float", True, "Weight for staleness score."),
            FieldInfo(
                "constraints_profile_overrides",
                "list[string]",
                False,
                "Optional override list for profile constraints.",
            ),
            FieldInfo(
                "sorting_policy",
                "string",
                False,
                "Sorting policy for deterministic ties.",
            ),
        ],
        cross_refs="Referenced by profiles.objective_preset and rules applies_if.",
    ),
    DictionaryEntry(
